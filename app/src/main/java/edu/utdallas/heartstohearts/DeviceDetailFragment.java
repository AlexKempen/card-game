...
//                final File f = new File(context.getExternalFilesDir("received"), "wifip2pshared-" + System.currentTimeMillis() + ".jpg");
//                File dirs = new File(f.getParent());
//                if (!dirs.exists()) dirs.mkdirs();
//                f.createNewFile();
//                Log.d(WiFiDirectActivity.TAG, "server: copying files " + f.toString());
                InputStream inputstream = client.getInputStream();
                Log.d("We did it reddit", new Scanner(inputstream).nextLine());
...
//                intent.setDataAndType("Hello world", "string/*");
